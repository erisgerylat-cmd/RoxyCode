...
export function createBuiltinCommands(options: BuiltinCommandFactoryOptions): CommandDefinition[] {
  ...
  return [
    ...
    },
    {
      ...
      source: 'builtin',
      type: 'local',
      usage: isZh ? '/character [role|info|list|create|packages|install|uninstall|update|validate]' : '/character [name|info|list|create|packages|install|uninstall|update|validate]',
      examples: ['/character', '/character roxy', '/character info', '/character create my-waifu-dev', '/character packages', '/character install ./roxy-sensei.roxychar', '/character validate ./roxy-sensei'],
      subcommands: [
