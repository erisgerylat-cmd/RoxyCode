...
export const i18n: Record<Language, I18nText> = {
  'zh-CN': {
    ...
    commands: {
      ...
      config: {
        description: '查看和修改配置，支持全局/项目/本地作用域',
        ...
        paths: '配置路径',
        invalidUsage: '用法错误',
        invalidScope: '不支持的作用域，请使用 global、project 或 local',
        parseFailed: '配置值解析失败',
        missingPath: '请提供配置路径',
        examples: '示例: /config get ui.language · /config set character.current roxy --scope local',
      },
  ...
  'en-US': {
    ...
    commands: {
      ...
      config: {
        description: 'View and edit configuration with global/project/local scopes',
        usage: '/config [get|set|paths] ...',
        title: 'Configuration',
        ...
        invalidScope: 'Unsupported scope. Use global, project, or local',
        parseFailed: 'Failed to parse config value',
        missingPath: 'Please provide a config path',
        examples: 'Examples: /config get ui.language · /config set character.current roxy --scope local',
      },
